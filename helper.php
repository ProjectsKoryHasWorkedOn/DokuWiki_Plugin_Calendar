...
class helper_plugin_ijsyouridea extends DokuWiki_Plugin {
  ...
  public function __construct() {
    dbglog('---- ijsyouridea helper.php init');
  }
  ...
  private function getDB()
  {
      if($this->sqlite === null)
      {
        ...
        if(!$this->sqlite->init('ijsyouridea', DOKU_PLUGIN.'ijsyouridea/db/'))
        {
            $this->sqlite = null;
            dbglog('Error initialising the SQLite DB for calender plugin');
            return false;
        }
      }
      return $this->sqlite;
...
//always check if ownerid === currentUser.id
